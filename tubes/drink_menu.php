...
$query = "SELECT Menu.*, GROUP_CONCAT(Category.category_name SEPARATOR ', ') AS categories
          ...
          WHERE Menu_Category.category_id = 2
...
<head>
    ...
    <!-- ======== Title	 ======================== -->
    <title>GreenBites drink menu</title>
</head>
                ...
                <div class="container">
                    <div class="home__inner">
                        <div class="home__items">
                            <h1 class="home__title">Drink Menu</h1>
                            <div class="home__subtitle">GreenBites juga menyajikan minuman segar dengan berbagai perpaduan minuman rasa dan varian baru.</div>
                        </div>
                        <div class="home__image">
                            <img src="img/Drinks.png" alt="home image" class="home__img img" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="menus" id="menus">
                <div class="container">
                    <div class="menus__inner">
                        <h1 class="title">Drink Menu<span>.</span></h1>
